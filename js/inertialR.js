...
/// TODO: refactor acceleration function. Could be much tidier
...
// TODO: handle horizontal/vertical collisions more dynamically
  ...
  if (!opp && entity.touchedCount === currentMatch.checkpoints.length && circleCollision(entity, startFinish)) {
...
function toggleMenu() {
  $('#inertialR').toggleClass('openMenu');
}
